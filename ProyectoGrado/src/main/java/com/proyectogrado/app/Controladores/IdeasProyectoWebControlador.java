...
public class IdeasProyectoWebControlador {
	...
	public String verProyectosCreados(Model model) {
		...
		return "lista-proyectos-creados";
	}
...
*/
	...
	public String editarProyecto(@PathVariable String id, Model model) {
	    IdeasProyecto proyecto = repo.findById(id).orElse(null);
	    if (proyecto == null) {
	...
	public String actualizarProyecto(@ModelAttribute IdeasProyecto proyecto, Model model) {
		repo.save(proyecto);
	...
	public String guardarNuevoProyecto(@ModelAttribute IdeasProyecto proyecto, Model model) {
	    repo.save(proyecto);
	...
	public String proyectosSeleccionados(Model model) {
	    List<IdeasProyecto> seleccionados = repo.findByEstudianteIsNull();
	...
	public String escogerProyecto(@PathVariable String id, @RequestParam String estudianteId) {
	    ...
	    if (proyecto != null && proyecto.getEstudiante() == null) {
	        ...
	        Estudiante estudiante = new Estudiante(); // Crear una instancia del estudiante
	...
	public String verProyectoEstudiante(@PathVariable String id, Model model) {
		List<IdeasProyecto> proyectos = repo.findByEstudiante_Id(id);
	...
	public String verProyectosDocente(@PathVariable String id, Model model) {
		List<IdeasProyecto> proyectos = repo.findByDirectorIdOrEvaluadorId(id, id);
		model.addAttribute("proyectos", proyectos);
