...
public class CoordinadorWebControlador {
    ...
    public String crearProyecto(@PathVariable String id, @ModelAttribute IdeasProyecto proyecto) {
        Coordinador coordinador = coordinadorRepositorio.findById(id)
                .orElseThrow(() -> new RuntimeException("Coordinador no encontrado"));
    ...
    public String editarProyecto(@PathVariable String idProyecto, @ModelAttribute IdeasProyecto datosActualizados) {
        IdeasProyecto proyecto = ideasProyectoRepositorio.findById(idProyecto)
                .orElseThrow(() -> new RuntimeException("Proyecto no encontrado"));
    ...
    @GetMapping("/panelCoordinador")
    public String mostrarPanelCoordinador() {
        return "panelCoordinador"; // Asumiendo que usas Thymeleaf o JSP
    }
