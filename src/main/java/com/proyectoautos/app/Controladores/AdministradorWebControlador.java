...
import com.proyectoautos.app.Repositorios.AdministradorRepositorio;
...
public class AdministradorWebControlador {
	...
	public String verListaProfesores(Model model) {
		...
		model.addAttribute("profesor", new Empleado());
		return "verEmpleados";
	}
	...
	public String agregarProfesor(@ModelAttribute Empleado profesor, RedirectAttributes redirectAttributes) {
	...
	public String actualizarProfesor(Empleado profesor, RedirectAttributes redirectAttributes) {
		profesorRepositorio.save(profesor);
	...
	public String verListaCoordinadores(Model model) {
		...
		model.addAttribute("coordinador", new Gerente());
		return "verGerentes";
	}
	...
	public String agregarCoordinador(@ModelAttribute Gerente coordinador, RedirectAttributes redirectAttributes) {
	...
	public String actualizarCoordinador(@ModelAttribute Gerente coordinador, RedirectAttributes redirectAttributes) {
		coordinadorRepositorio.save(coordinador);
	...
	public String verListaEstudiantes(Model model) {
		...
		model.addAttribute("estudiante", new Cliente());
		return "verClientes";
	}
	...
	public String agregarEstudiante(@ModelAttribute Cliente estudiante, RedirectAttributes redirectAttributes) {
	...
	public String actualizarEstudiante(@ModelAttribute Cliente estudiante, RedirectAttributes redirectAttributes) {
		estudianteRepositorio.save(estudiante);
