...
public class LoginControlador {
    ...
    public String procesarLogin(@RequestParam String usuario, @RequestParam String password, HttpSession session, Model model) {
        ...
        Empleado profesor = profesorRepo.findByUsuarioAndPassword(usuario, password);
        Cliente estudiante = estudianteRepo.findByUsuarioAndPassword(usuario, password);
        Gerente coordinador = coordinadorRepo.findByUsuarioAndPassword(usuario, password);
